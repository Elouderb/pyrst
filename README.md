...
- Multi-file programs (`import` / `from … import`), a **51-module embedded standard library** (see below) including dotted submodules (`import os.path`, `import urllib.parse`), circular-import detection
